...
from build_dataset import _align_on_ppg_timestamps, _crop_to_overlap, _read_signal_csv
...
class PPGGSRDataset(Dataset):
    ...
    Input structure (raw mode):
      root_dir/<subject>/<session>/time_GSR.csv
      root_dir/<subject>/<session>/time_PPG.csv
    ...
    def _build_index(self) -> None:
        for subject_dir in sorted(self.root_dir.iterdir()):
            ...
            for session_dir in sorted(subject_dir.iterdir()):
                ...
                gsr_path = session_dir / "time_GSR.csv"
                ppg_path = session_dir / "time_PPG.csv"
